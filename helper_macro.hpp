...
#define ABF_CONST_FIELD(BF, T, NAME, ...)                                      \
  ...
  {                                                                            \
    return static_cast<T>(abf::detail::field_ref<                              \
                          typename std::add_const<typename BF::Alias>::type,   \
                          T,                                                   \
...
#define ABF_FIELD(BF, T, NAME, ...)                                            \
  ...
  abf::detail::field_ref<typename BF::Alias, T, __VA_ARGS__> NAME() noexcept   \
  {                                                                            \
    return abf::detail::field_ref<typename BF::Alias, T, __VA_ARGS__>(         \
      this->BF::storage);                                                      \
  }                                                                            \
                                                                               \
